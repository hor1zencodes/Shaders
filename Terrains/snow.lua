...
local function processPart(part)
    pcall(function()
        ...
        if isBaseplate(part) then
            ...
            workspace.Terrain:FillBlock(part.CFrame * CFrame.new(0, -1.5, 0), part.Size, Enum.Material.Snow)
...
if not foundAny then
    workspace.Terrain:FillBlock(CFrame.new(0,-2,0), Vector3.new(2000, 4, 2000), Enum.Material.Snow)
end
