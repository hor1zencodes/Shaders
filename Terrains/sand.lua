...
local function processPart(part)
    pcall(function()
        ...
        if isBaseplate(part) then
            -- Lower the terrain visually by 1.6 studs so it doesn't clip above the floor
            workspace.Terrain:FillBlock(part.CFrame * CFrame.new(0, -1.6, 0), part.Size, Enum.Material.Sand)
